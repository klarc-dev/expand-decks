...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "presentations" DROP CONSTRAINT IF EXISTS "presentations_current_media_production_request_id_media_production_requests_id_fk";

  ALTER TABLE "media" DROP CONSTRAINT IF EXISTS "media_media_production_request_id_media_production_requests_id_fk";

  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT IF EXISTS "payload_locked_documents_rels_media_production_requests_fk";

  DROP INDEX IF EXISTS "presentations_current_media_production_request_idx";
  DROP INDEX IF EXISTS "media_media_production_request_idx";
  DROP INDEX IF EXISTS "media_producer_request_id_idx";
  DROP INDEX IF EXISTS "media_publication_id_idx";
  DROP INDEX IF EXISTS "payload_locked_documents_rels_media_production_requests__idx";
  ALTER TABLE "presentations" DROP COLUMN IF EXISTS "draft_trace_id";
  ALTER TABLE "presentations" DROP COLUMN IF EXISTS "current_media_production_request_id";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "media_production_request_id";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "producer_contract";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "producer_request_id";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "publication_id";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "revision_sha256";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "artifact_order";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "artifact_group";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "artifact_role";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "artifact_media_type";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "artifact_bytes";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "artifact_sha256";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "artifact_page_count";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "artifact_width_px";
  ALTER TABLE "media" DROP COLUMN IF EXISTS "artifact_height_px";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN IF EXISTS "media_production_requests_id";
  DROP TABLE IF EXISTS "media_production_requests" CASCADE;
  DROP TYPE IF EXISTS "public"."enum_media_production_requests_format";
  DROP TYPE IF EXISTS "public"."enum_media_production_requests_status";`);
}
