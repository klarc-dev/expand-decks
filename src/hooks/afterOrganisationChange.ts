...
/**
 * When an organisation's brand (colors/logo/fonts) changes, every presentation
 * that references it must rebuild — its baked SPA/PDF still carry
 * the old theme. Fan out a build job per referencing deck.
 *
